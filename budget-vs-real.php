...
<head>
  ...
  <title>Highrise – Budget vs Real</title>
...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
      ...
      <a href="budget-vs-real.php" class="nav__item active">
        <svg class="nav__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
  ...
  <div class="main" id="main">
    ...
    <header class="topbar">
      ...
      <span class="topbar__title">Budget vs Real</span>
      <div class="topbar__spacer"></div>
    </header>

    <div class="content">
      <h1 class="page-title">Budget vs Real</h1>
      <p class="page-sub">Budget performance and cost breakdown analysis</p>
