...
<head>
  ...
  <link rel="stylesheet" href="CSS/tenant_dues.css?v=10" />
  <link rel="stylesheet" href="CSS/financial_details.css?v=10" />
</head>
<body>
        ...
        <table class="dues-table" id="financialTable">
          <thead>
            <tr>
              ...
              <th class="sortable" data-col="cost_name">Budget Item <span class="sort-icon">↕</span></th>
  ...
  <script src="JS/financial_details.js?v=2"></script>
</body>
</html>
