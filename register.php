...
<head>
  ...
  <title>Highrise – Register User</title>
...
<body>
  ...
  <div class="main" id="main">
    ...
    <header class="topbar">
      ...
      <span class="topbar__title">Register User</span>
      <div class="topbar__spacer"></div>
    </header>

    <div class="content">
      <h1 class="page-title">Register User</h1>
      <p class="page-sub">Create a new account for a team member</p>

      <div class="upload-card" style="margin-top:28px; max-width:480px;">

        <div class="form-group" style="margin-bottom:18px;">
          <label class="form-label" style="display:block;margin-bottom:6px;font-size:0.72rem;font-weight:500;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-secondary);">Username</label>
          <input type="text" id="txtName" class="project-select" style="width:100%;max-width:100%;" placeholder="Enter username" autocomplete="off" />
        </div>

        <div class="form-group" style="margin-bottom:18px;">
          <label class="form-label" style="display:block;margin-bottom:6px;font-size:0.72rem;font-weight:500;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-secondary);">User Type</label>
          <select id="selectUserType" class="project-select" style="width:100%;max-width:100%;">
            <option value="">Loading...</option>
          </select>
        </div>

        <div class="form-group" style="margin-bottom:18px;">
          <label class="form-label" style="display:block;margin-bottom:6px;font-size:0.72rem;font-weight:500;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-secondary);">Password</label>
          <input type="password" id="txtPassword" class="project-select" style="width:100%;max-width:100%;" placeholder="••••••••" autocomplete="new-password" />
        </div>

        <div class="form-group" style="margin-bottom:24px;">
          <label class="form-label" style="display:block;margin-bottom:6px;font-size:0.72rem;font-weight:500;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-secondary);">Confirm Password</label>
          <input type="password" id="txtConfirm" class="project-select" style="width:100%;max-width:100%;" placeholder="••••••••" autocomplete="new-password" />
        </div>

        <p id="registerMsg" style="font-size:0.82rem;margin-bottom:12px;display:none;"></p>

        <button class="btn-upload" id="btnRegister" disabled style="width:100%;justify-content:center;">
